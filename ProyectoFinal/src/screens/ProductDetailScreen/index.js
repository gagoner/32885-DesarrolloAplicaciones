    ...
    return (
        <ScrollView style={styles.container}>
            ...
            <View style={styles.product}>
                ...
                <View>
                    <Text style={styles.freeShipping}>{!!freeShipping && 'Free shipping!'}</Text>
                </View>
                <View >
                ...
                <View style={styles.stats}>
                    ...
                    <Text style={styles.statText}>{opinions} opinions</Text>
                    <Text style={styles.statText}>{stars} stars</Text>
                </View>
                {
                    amountAvailable < 1
                        ?
                        <Text style={styles.noStock}>Sorry, no more products available</Text>
                        :
                        <>
                            <View>
                                <Text style={styles.selectedQuantity}>Selected quantity: {selectedQuantity}</Text>
                                <Text style={styles.amountAvailable}>Amount Available: {amountAvailable}</Text>
