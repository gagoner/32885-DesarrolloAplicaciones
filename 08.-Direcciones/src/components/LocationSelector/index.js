    ...
    const verifyPermissions = async () => {
        ...
        if (status !== 'granted') {
            ...
            Alert.alert(
                ...
                'You need permission to use the location',
                [{ text: 'ok' }]
            )
    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.buttons}>
                <Button title='Get location' color={primaryBg} onPress={handleGetLocation} />
                <Button title='Choose map' color={primaryBg} onPress={handlePickLocation} />
            </View>
        </View>
    )
}
